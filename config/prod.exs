...
config :hitbit, HitbitWeb.Endpoint,
  ...
  server: true,
  version: Application.spec(:hitbit, :vsn)

config :hitbit, Hitbit.Plug.CORS,
  origins: "*",
  methods: ["POST"]

# Do not expose graphiql route by default
config :hitbit, HitbitWeb.Router, graphiql: false
...
# start per endpoint:
#
#     config :hitbit, HitbitWeb.Endpoint, server: true
#
